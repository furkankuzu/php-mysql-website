...
$db = getDB();
$data = $db->query("SELECT * FROM web ORDER By id DESC Limit 1")->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="ashade-content-scroll">
            <div class="ashade-content">
                    ...
                    <div class="ashade-row mt-100">
                        <div class="ashade-col col-4">
                            ...
                            <div class="text-center mt-10 box-desc">
                                Mobil ve seo uyumlu web tasarım çözümlerimizle potansiyel müşterilerinize ulaşmanızı sağlıyoruz.
                            </div>
                        ...
                        <div class="ashade-col col-4">
                            ...
                            <div class="text-center mt-10 box-desc">
                                Dijital medya ekibimizle markanızıın hedefe ulaşması yolunda profesyonel paylaşımlara imza atıyoruz.
                            </div>
                        ...
                        <div class="ashade-col col-4">
                            ...
                            <div class="text-center mt-10 box-desc">
                                Web sayfanızın Google arama sonuçlarında üst sıralarda yer almasını sağlayan çalışmalar yapıyoruz.
                            </div>
                ...
                <section class="ashade-section">
                    <div class="ashade-row">
                        <div class="ashade-col col-12 text-center">
                            <h4>Öne Çıkan Web Tasarım Projelerimiz</h4>
                        </div>
                    </div>

                    <div class="ashade-grid ashade-grid-3cols mt-70 mb-70">
                        <?php
                        $cek = $db->prepare("SELECT * FROM web_projeler ORDER By id DESC");
                        $cek->execute();
                        foreach ($cek as $key) {
                            if(empty($key["resim"])){
