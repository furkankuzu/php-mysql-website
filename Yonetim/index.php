...
<head>
  <meta charset="utf-8">
    ...
    <title>Alkosoft Yönetim Paneli-Giriş</title>
...
<body>
        ...
        <form action="" method="post">
          ...
          <div class="login-form-body">
            <div class="form-gp">
              ...
              <input type="text" name="kulad" id="kuladlab" placeholder="Kullanıcı adınızı giriniz."/>
              <i class="ti-user"></i>
            </div>

            <div class="form-gp">
              
              <input type="password" name="sifre" id="sifrelab" placeholder="Şifrenizi giriniz."/>
              <i class="ti-lock"></i>
            </div>
  ...
  <?php
    ...
    if($kulad==""&& $sifre==""):
      ...
      echo'
      <div class="container-fluid bg-white ptb--150">
        <div class="alert alert-white border border-dark mt-5 col-md-5 mx-auto p-3 text-dark font-14 font-weight-bold">
          <img src="loading.gif" width="150" /><br>BİLGİLER BOŞ BIRAKILAMAZ !<br> YÖNLENDİRİLİYOR...
        </div>
      </div>';
      ...
      //veritabanından kontrol işlemleri...
