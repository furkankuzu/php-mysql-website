...
$db = getDB();
$data = $db->query("SELECT * FROM mobil_uygulama ORDER By id DESC Limit 1")->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="ashade-content">
        ...
        <section class="ashade-section">
          ...
          <div class="ashade-grid ashade-grid-3cols mt-70 mb-70">
            <?php
            $cek = $db->prepare("SELECT * FROM web_projeler WHERE kategoriid=3  ORDER By id DESC");
            $cek->execute();
            foreach ($cek as $key) {
              if (empty($key["resim"])) {
